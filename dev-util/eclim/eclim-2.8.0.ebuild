...
SRC_URI="https://github.com/ervandew/eclim/releases/download/${PV}/eclim_${PV}.tar.gz -> ${P}.tar.gz"
...
COMMON_DEPEND="dev-util/eclipse-sdk-bin:4.8"
...
S=${WORKDIR}/${MY_P}
eclipse_home="/opt/eclipse-sdk-bin-4.8/"
